    ...
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content ">
                <div className='footer w-4/5 mx-auto'>
                    <aside>
                        <img src={logo} alt="" />
                    ...
                    <nav>
                        ...
                        <a className="link link-hover">Plans & Pricing
                        </a>
                    ...
                    <nav>
                        ...
                        <a className="link link-hover">PSales</a>
                        <a className="link link-hover">Become a Partner</a>
                        <a className="link link-hover">Developers</a>
                    </nav>
                    <nav>
                        <header className="footer-title">Contact</header>
                        <a className="link link-hover">T524 Broadway , NYC
                        </a>
